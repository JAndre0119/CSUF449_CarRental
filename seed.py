...
with app.app_context():
    ...
    cars = [
        # Sedans
        Car(name="Toyota Camry", make="Toyota", model="Camry", year=2022, price_per_day=60, total_quantity=3, image_filename="toyota_camry.jpg"),
        Car(name="Honda Accord", make="Honda", model="Accord", year=2023, price_per_day=65, total_quantity=3, image_filename="2023Honda_Accord.jpg"),
        Car(name="Nissan Altima", make="Nissan", model="Altima", year=2021, price_per_day=55, total_quantity=2, image_filename="2021Nissan_Altima.jpg"),
        Car(name="Hyundai Sonata", make="Hyundai", model="Sonata", year=2022, price_per_day=58, total_quantity=2, image_filename="2022Hyundai_Sonata.jpg"),

        # Compact Cars
        Car(name="Toyota Corolla", make="Toyota", model="Corolla", year=2022, price_per_day=45, total_quantity=3, image_filename="2022Toyota_Corolla.jpg"),
        Car(name="Honda Civic", make="Honda", model="Civic", year=2023, price_per_day=50, total_quantity=3, image_filename="2023Honda_Civic.jpg"),
        Car(name="Mazda 3", make="Mazda", model="3", year=2021, price_per_day=48, total_quantity=2, image_filename="2021Mazda_3.jpg"),
        ...
        Car(name="Ford Escape", make="Ford", model="Escape", year=2021, price_per_day=70, total_quantity=2, image_filename="2021Ford_Escape.jpg"),
        ...
        Car(name="Audi A4", make="Audi", model="A4", year=2021, price_per_day=130, total_quantity=1, image_filename="2021Audi_A4.jpg"),
        ...
        Car(name="Tesla Model Y", make="Tesla", model="Model Y", year=2022, price_per_day=130, total_quantity=2, image_filename="2022TeslaModel_Y.jpg"),
        ...
        Car(name="Toyota Tacoma", make="Toyota", model="Tacoma", year=2023, price_per_day=85, total_quantity=2, image_filename="2023Toyota_Tacoma.jpg"),
        ...
        # Sports Cars
        Car(name="Ford Mustang", make="Ford", model="Mustang", year=2023, price_per_day=150, total_quantity=1, image_filename="2023Ford_Mustang.jpg"),
